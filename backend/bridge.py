...
ALLOWED_TOOLS = {
    "nmap", "gobuster", "ffuf", "feroxbuster", "nikto", "whatweb", "wafw00f", "nuclei", "subfinder", "httpx", "hydra", "sqlmap",
    "wpscan",
...
PHASE_TOOLS = {
    1: {"nmap", "whatweb", "wafw00f", "subfinder", "httpx", "dig", "nslookup", "dnsrecon", "ldapsearch",
