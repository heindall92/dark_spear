...
- **Inyección** — SQLi y NoSQLi en login (operadores Mongo `$gt`), XSS reflejado con marcador único, open redirect, IDOR genérico contra recursos REST por ID numérico.
